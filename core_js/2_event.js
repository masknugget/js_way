...
// And don't let the event propagate any further.
    ...
    < script
src = "getScrollOffsets.js" > < /script> <!-- drag() requires this -->
    < script
src = "Drag.js" > < /script> <!-- defines drag() -->
    <!-- The element to be dragged -->
    < div
style = "position:absolute; left:100px; top:100px; width:250px;
background - color
:
white;
border: solid
...
attribute.-- >
< div
style = "background-color: gray; border-bottom: dotted black;
padding: 3
px;
font - family
:
...
is
a
test.Testing, testing, testing. < /p><p>Test</
p > < p > Test < /p>
< /div>


< script
src = "whenReady.js" > < /script>
    < script
src = "Enclose.js" > < /script>
    < script >
    whenReady(function () {
...
clock < /h1>
< span
id = "clock" > < /span> <!-- The time is displayed here -->
    < textarea
cols = 60
rows = 20 > < /textarea> <!-- You can drop timestamps here -->

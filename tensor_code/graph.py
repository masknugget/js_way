...
print("Shallow Model - Eager execution time:",
      timeit.timeit(lambda: model_shallow_with_eager(sample_input), number=1000))

print("Shallow Model - Graph-based execution time:",
      timeit.timeit(lambda: model_shallow_on_graph(sample_input), number=1000))
...
Shallow Model - Eager execution time: 1.6742201000000003
Shallow Model - Graph-based execution time: 0.7232973999999999

Deep Model - Eager execution time: 6.101133600000001
Deep Model - Graph-based execution time: 4.967289599999999
